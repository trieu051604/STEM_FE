...
export const AssignmentCard: React.FC<AssignmentCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className="bg-card rounded-xl border border-border overflow-hidden hover:border-indigo-500/40 transition-colors group"
    >
      <div className="p-6">
        <div className="flex justify-between items-start mb-4">
          <div className="flex flex-col gap-2">
            <div className="bg-indigo-500/10 text-indigo-400 px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wider w-fit">
        ...
        <h3 className="text-lg font-bold text-foreground mb-2 line-clamp-2 group-hover:text-indigo-400 transition-colors">
          {assignment.title}
        </h3>
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <div className="rounded-lg bg-muted/50 border border-border p-3">
            <p className="text-xs text-muted-foreground mb-1">{stat1Label}</p>
            <p className="text-2xl font-bold text-foreground">
              {assignment.submissionCount}
            </p>
          </div>
          <div className="rounded-lg bg-muted/50 border border-border p-3">
            <p className="text-xs text-muted-foreground mb-1">{stat2Label}</p>
            <p className="text-2xl font-bold text-foreground">
        ...
        <div className="flex items-center justify-between text-sm text-muted-foreground bg-muted/50 p-3 rounded-lg border border-border">
          <div className="flex items-center gap-2">
            <Clock className="w-4 h-4 text-amber-500" />
            <span>
              Cập nhật:{' '}
              <span className="font-semibold text-foreground">{formatDate(assignment.updatedAt)}</span>
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 py-4 bg-muted/30 border-t border-border flex justify-between items-center">
        ...
        <Button
          ...
          className="bg-indigo-500 hover:bg-indigo-600 text-white border-0 px-4 py-2 rounded-lg text-sm font-semibold transition-colors flex items-center gap-1 h-auto"
        >
