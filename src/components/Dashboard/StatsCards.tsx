  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
      ...
      <StatCard
        ...
        value={stats.pendingSchoolRequests}
        icon="ClipboardCheck"
        description="Đơn đăng ký mới"
        className={stats.pendingSchoolRequests > 0 ? 'border-yellow-500/50' : ''}
      />
      <StatCard
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
      ...
      <StatCard
        ...
        className={stats.pendingAssignments > 0 ? 'border-yellow-500/50' : ''}
      />
    </div>
  );
};
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
      ...
      <StatCard
        ...
        className={stats.pendingSubmissions > 0 ? 'border-yellow-500/50' : ''}
      />
    </div>
  );
};
